...
import {defaultSearch as managerDefaultSearch} from "@/presentation/routes/_authenticated/manager/dashboard/repair-requests";
import {defaultSearch as engineerDefaultSearch} from "@/presentation/routes/_authenticated/engineer/dashboard/repair-requests";
...
const RepairRequestDetailsPage = () => {
    ...
    const goToEngineerDashboard = () => { navigate({to: "/engineer/dashboard/repair-requests", search: {...engineerDefaultSearch, page: "1", limit: "15"}}); }
    const goToManagerDashboard = () => { navigate({to: "/manager/dashboard/repair-requests", search: {...managerDefaultSearch, page: "1", limit: "15"}}); }
